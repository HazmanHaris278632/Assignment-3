...
public class PlayerRegistration extends JFrame {
	...
	public PlayerRegistration() {
		...
		resetButton.setBounds(212, 36, 135, 82);
		...
		deleteButton.setBounds(637, 36, 135, 82);
		...
		btnNext.setBounds(851, 36, 135, 82);
		btnNext.setBorder(new LineBorder(new Color(0, 0, 0), 4));
		panel_1_1_2.add(btnNext);
		
		JButton uploadButton = new JButton("UPLOAD");
		uploadButton.setBounds(421, 34, 135, 84);
